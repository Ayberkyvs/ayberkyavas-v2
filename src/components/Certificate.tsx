...
export default function Certificate({data}: {data: any}) {
  return (
    <RouterLink className="relative flex flex-col w-[224px] items-center
    rounded-[16px] bg-transparent hover:bg-gradient-to-r from-[#1E1C32]/50 
    to-[#2B161D]/50 md:min-h-[302px] h-fit p-[12px] text-primary-text cursor-pointer" to={data.link ? data.link : undefined}>
