...
export default function Certificate() {
  return (
    <div className="relative flex flex-col w-[224px] min-w-[224px] items-center 
    rounded-[16px] bg-transparent hover:bg-gradient-to-r from-[#1E1C32]/50 
    to-[#2B161D]/50 md:min-h-[302px] h-fit p-[12px] text-primary-text">
        ...
        <img src={Placeholder} alt="" className="rounded mr-[12px] md:mr-0 w-full md:w-[200px] md:h-[200px] mb-[8px]" draggable={false}/>
